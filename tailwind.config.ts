    ...
    extend: {
      ...
      colors: {
        ...
        text: {
          ...
          offWhite1: "rgba(240, 240, 245, 0.9)", // soft white with a hint of gray
          offWhite2: "rgba(235, 235, 240, 0.9)", // slightly darker grayish white
          offWhite3: "rgba(250, 250, 255, 0.95)", // very soft blue-white
          offWhite4: "rgba(245, 245, 250, 0.7)", // cool white with a subtle blue hint
