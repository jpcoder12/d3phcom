...
export function TweetCard({ tweet }: TweetCardProps) {
  ...
  return (
    <Link href={`https://x.com/MacRumors/status/${tweet.tweet_id}`} passHref target='_blank'>
      <Card className=' xs:w-[400px] xs:h-[200px]  sm:w-[500px] md:w-[600px] lg:w-[300px] xl:w-[400px] xl:h-[280px]  4xl:h-[290px] 4xl:w-[780px] flex flex-col bg-card border border-card-border hover:bg-black rounded-lg'>
