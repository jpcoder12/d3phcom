...
export function SkeletonCard() {
  return (
    <div className=' xs:w-[700px] xs:h-[200px]  sm:w-[700px] md:w-[600px] lg:w-[300px] xl:w-[550px] xl:h-[280px]   4xl:h-[290px] 4xl:w-[780px] flex flex-col bg-card border border-card-border rounded-lg p-4 animate-pulse'>
